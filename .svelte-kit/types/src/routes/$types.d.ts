...
type LayoutRouteId = RouteId | "/(app)/[tenant]/settings" | "/(app)/[tenant]/todos" | "/(public)" | "/(public)/auth/login" | "/(public)/auth/register" | "/(public)/auth/verify" | null
type LayoutParams = RouteParams & { tenant?: string }
