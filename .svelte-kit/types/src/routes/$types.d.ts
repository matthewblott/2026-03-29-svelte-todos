...
type LayoutRouteId = RouteId | "/(app)/[tenant=username]/settings" | "/(app)/[tenant=username]/todos" | "/(public)" | "/(public)/auth/login" | "/(public)/auth/register" | "/(public)/auth/verify" | null
